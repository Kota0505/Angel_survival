...
public class Lv_up_window : MonoBehaviour
{
    ...
    void Lv_up_select()
    {
        ...
        weapon_data.Add("bible", new List<string>(){weapon_dic_copy["bible"].ToString(),"The Bible moves in a circle around you, damaging enemies it touches", "The speed and attack power of bible will increase"});
        ...
        weapon_data.Add("holy_water", new List<string>(){weapon_dic_copy["holy_water"].ToString(),"Holy water falls around you and spreads over a certain area", "Shorter intervals of holy water fall, range and attack power will increase"});
        weapon_data.Add("ax", new List<string>(){weapon_dic_copy["ax"].ToString(),"The axe attacks enemys with high power", "axe's power, num, and size is more stronger"});
        weapon_data.Add("rune", new List<string>(){weapon_dic_copy["rune"].ToString(),"rune_tracer attack enemys", "Num of rune will Increase"});
        weapon_data.Add("division_shot", new List<string>(){weapon_dic_copy["division_shot"].ToString(),"division_shot attacks most nearest enemy and spreads", "The power of division_shot will increase"});
        weapon_data.Add("full_recovery1", new List<string>(){"0", "Recovers your HP to the maximum", "Recovers your HP to the maximum"});
        weapon_data.Add("full_recovery2", new List<string>(){"0", "Recovers your HP to the maximum", "Recovers your HP to the maximum"});
        weapon_data.Add("full_recovery3", new List<string>(){"0", "Recovers your HP to the maximum", "Recovers your HP to the maximum"});
